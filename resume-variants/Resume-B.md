...
<!-- Resume B — Product / Consumer. Use when: Consumer product company, growth/experimentation, or UX-forward role -->

**Summary**

Product-focused Senior Front-End Engineer with 8+ years building high-traffic consumer web applications in React and TypeScript, used by millions at theScore and ESPN BET. I own features end-to-end with a strong emphasis on UX, A/B experimentation, and performance, partnering closely with design and product to ship interfaces that move both customer and business metrics.
