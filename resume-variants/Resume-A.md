...
adkins.kendall90@gmail.com • San Diego, CA  
https://kendalladkins.dev  
https://www.linkedin.com/in/adkinskendall/

<!-- Resume A — AI-focused. Use when: JD names AI-assisted development, copilots, agent workflows, or LLM tooling (required or preferred) -->

**Summary**

Senior Front-End Engineer who pairs 8+ years of React and TypeScript expertise with team-level AI-assisted engineering leadership, having led Claude Code adoption at theScore. I ship high-traffic, high-reliability interfaces and own features from concept to production, using an AI-native workflow to move faster without trading away performance, accessibility, or code quality.
...
* Drove UX polish with researchers and back-end teams; improved time-to-insight for analysts.
* *Tech:* AngularJS / 10+, TypeScript, Node, Java, SQL
